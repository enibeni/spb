...
def test_spb_form(app, json_dispatch, json_sender, json_reciver, json_attach, json_blank):
    ...
    # FORM 3
    app.attach.fill_attach(attach.attach_name, attach.count, attach.cost, attach.weight, attach.TNVED, attach.country)
    # app.attach.fill_attach(attach)
